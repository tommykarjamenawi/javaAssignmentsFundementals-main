    ...
    public static void screen() {
        ...
        movieTableView1.setOnMouseClicked((MouseEvent event) -> {
            if (movieTableView1.getSelectionModel().getSelectedItem() != null){
                ...
                RoomDetails.vbox("Room 1", model.getTitle(), model.getStart(), model.getEnd(), Double.parseDouble(String.valueOf(model.getPrice())));
            }
        });
        ...
        movieTableView2.setOnMouseClicked((MouseEvent event) -> {
            if (movieTableView2.getSelectionModel().getSelectedItem() != null){
                ...
                RoomDetails.vbox("Room 2", model.getTitle(), model.getStart(), model.getEnd(), Double.parseDouble(String.valueOf(model.getPrice())));
            }
        });
